        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              // color: Colors.green,
              child: Center(
                  child: Text("7. exit", style: GoogleFonts.archivo(textStyle: TextStyle(color: kPrimaryColor, fontSize: 32.sp, fontWeight: FontWeight.w500)))),
            ),
            Container(
              height: 10.h,
              width: 100.w,
            ...
            Container(
              ...
              child: GestureDetector(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => OrganScreen(),),);
                },
