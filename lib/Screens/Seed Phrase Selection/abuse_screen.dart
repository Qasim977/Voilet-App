...
import 'abuse_screen_2.dart';

class AbuseScreen extends StatelessWidget {
  const AbuseScreen({Key? key}) : super(key: key);
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              // color: Colors.green,
              child: Center(
                  child: Text("3. abuse", style: GoogleFonts.archivo(textStyle: TextStyle(color: kPrimaryColor, fontSize: 32.sp, fontWeight: FontWeight.w500)))),
            ),
            Container(
              height: 10.h,
              width: 100.w,
            ...
            Container(
              ...
              child: GestureDetector(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => AbuseScreen2(),),);
                },
